...
#L_tip = 150.0e3/d_nondim # Plate Tip Length
#Alpha_dip = 45 # Plate Dip Angle in degrees
Roc = 250.0e3/d_nondim # Radius of curvature
beta = 77 # angle of curvature

# Fixed Parameters

#g = 10.0 # gavitational acceleration
...
# Variable Parameters
W_plate = (4800.0e3/2.0)/d_nondim # Plate Width
