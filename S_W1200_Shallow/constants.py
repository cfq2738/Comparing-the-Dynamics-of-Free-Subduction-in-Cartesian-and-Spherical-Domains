...
# Blob Width
blob_width = 1200.0e3/d_nondim

# Blob thickness
blob_thickness = 100.0e3/d_nondim # blob_thickness = h for a vertical case

# Blob distance E/W from trench
blob_dist = 100.0e3/d_nondim

# Blob Top Depth
blob_top = 150.0e3/d_nondim

# Blob Bottom Depth
blob_bottom = 550.0e3/d_nondim
